...
function Home() {
  ...
  return (
    <div>
      {/* Hero section */}
      <section className="bg-brand-primary text-white px-6 py-16 md:py-24">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-3xl md:text-5xl font-bold leading-tight">
            Good food is closer than you think.
          </h1>
          <p className="mt-4 text-white/90 text-lg md:text-xl">
            Discover delicious meals from local Nigerian food vendors around you and order with ease.
          </p>
          <Link
            to="/menu"
            className="inline-block mt-8 bg-white text-brand-primary font-semibold px-8 py-3 rounded-xl hover:bg-brand-light transition-colors"
          >
            Explore Food
          </Link>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
          {categories.map(({ name, icon: Icon }) => (
            ...
            >
              ...
              <span className="text-sm font-medium text-brand-dark text-center">{name}</span>
            </Link>
          ))}
        </div>
      </section>
      ...
      <section className="bg-brand-light px-6 py-14">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-2xl font-bold text-brand-dark">Popular Meals</h2>
            <Link to="/menu" className="text-brand-primary font-medium text-sm hover:underline">
              View all
            </Link>
          </div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-14 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="text-center">
          ...
          <h3 className="mt-4 font-semibold text-brand-dark">Browse the Menu</h3>
        ...
        <div className="text-center">
          ...
          <h3 className="mt-4 font-semibold text-brand-dark">Add to Cart</h3>
          <p className="mt-2 text-sm text-brand-gray">
        ...
        <div className="text-center">
          ...
          <h3 className="mt-4 font-semibold text-brand-dark">Track Your Order</h3>
          <p className="mt-2 text-sm text-brand-gray">
      ...
      <section className="bg-brand-light px-6 py-14">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-2xl font-bold text-brand-dark mb-2">Now Serving</h2>
          <p className="text-brand-gray mb-8">Bringing local vendors to more Nigerian cities.</p>
      ...
      <section className="px-6 py-14 text-center">
        <h2 className="text-2xl font-bold text-brand-dark">Hungry already?</h2>
        <p className="mt-2 text-brand-gray">Your next meal is a few taps away.</p>
        <Link
          to="/menu"
