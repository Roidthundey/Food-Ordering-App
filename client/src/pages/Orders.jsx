...
function Orders() {
  ...
  return (
    <div className="p-6 md:p-8 max-w-3xl mx-auto">
      <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Your Orders</h1>
        ...
        {orders.map((order) => (
          <div key={order.id} className="bg-white rounded-2xl shadow-sm p-5">
            ...
            <div className="border-t pt-3 flex justify-between items-center">
             ...
             <span className="font-bold text-brand-primary">{formatCurrency(order.total)}</span>
            </div>
          </div>
        ))}
      </div>
